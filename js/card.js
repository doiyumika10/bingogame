...
for (let i = 0; i < 1; i++) {
    tr = '<tr>';
    tr += `<td class="bgcolor1">${arrShuffleB[i+2]}</td>`;
    tr += `<td class="bgcolor2">${arrShuffleI[i+2]}</td>`;
    tr += `<td id="free">FREE</td>`;
    tr += `<td class="bgcolor2">${arrShuffleG[i+2]}</td>`;
    tr += `<td class="bgcolor1">${arrShuffleO[i+2]}</td>`;
    tr += '</tr>'
    document.getElementById('body').insertAdjacentHTML('beforeend', tr);
}
...
for (let i = 0; i < 2; i++) {
    tr = '<tr>';
    tr += `<td class="bgcolor1">${arrShuffleB[i+3]}</td>`;
    tr += `<td class="bgcolor2">${arrShuffleI[i+3]}</td>`;
    tr += `<td class="bgcolor1">${arrShuffleN[i+2]}</td>`;
    tr += `<td class="bgcolor2">${arrShuffleG[i+3]}</td>`;
    tr += `<td class="bgcolor1">${arrShuffleO[i+3]}</td>`;
    tr += '</tr>'
    document.getElementById('body').insertAdjacentHTML('beforeend', tr);
}
...
for (let i = 1; i < 16; i++) {
    colIdB = document.getElementById('td' + String(arrB[i]));
}

for (let i = 1; i < 16; i++) {
    colIdI = document.getElementById('td' + String(arrI[i]));
}

for (let i = 1; i < 16; i++) {
    colIdN = document.getElementById('td' + String(arrN[i]));
}

for (let i = 1; i < 16; i++) {
    colIdG = document.getElementById('td' + String(arrG[i]));
}

for (let i = 1; i < 16; i++) {
    colIdO = document.getElementById('td' + String(arrO[i]));
}
